...
/**
 *  hadoop jar target/hadoop-drdobbs-1.0.0.jar com.nik.loremipsum.WordCountJob -D mapred.reduce.tasks=4 (may output 4 files)
...
public class WordCountJob extends Configured implements Tool {
	...
	public int run(String[] arg0) throws Exception {
		...
		job.setMapperClass(LoremipSumMapper.class);
